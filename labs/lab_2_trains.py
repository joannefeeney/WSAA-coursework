# lab_2_trains.py
# By Joanne Feeney
# In this lab I will write a program that prints the data for all trains in Ireland to the console. 
...
#  print out each of the trainscodes
...
# append in the traincode and store that in the CSV
dataList = [] 
